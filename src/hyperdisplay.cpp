...
void hyperdisplay::yline(uint16_t x0, uint16_t y0, uint16_t len, color_t color[], uint16_t colorCycleLength, uint16_t width)
{
...
void hyperdisplay::fillFromArray(uint16_t x, uint16_t y, uint16_t size, color_t data[])
{
